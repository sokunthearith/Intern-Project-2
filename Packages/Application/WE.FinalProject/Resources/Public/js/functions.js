...
jQuery(document).ready(function() {
    ...
    jQuery('.list').on("click", function() {
        ...
        jQuery.ajax({
            type: "GET",
            url: "http://local.finalproject.dev/_Resources/Static/Packages/WE.FinalProject/js/form" + selectId + ".json",
            dataType: "text",
    ...
    jQuery.ajax({
        type: "GET",
        url: "http://local.finalproject.dev/_Resources/Static/Packages/WE.FinalProject/js/homepagecontent.json",
        dataType: "text",
        success:function(res) {
            var data = JSON.parse(res);
            for (var q in data) {
